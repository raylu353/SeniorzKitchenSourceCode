...
public class UsersFacadeREST extends AbstractFacade<Users> {
    ...
    public Users findByEmail(@PathParam("email") String email) {
        return (Users)em.createNativeQuery("select * from Users u where u.user_email='" + email + "';",Users.class).getSingleResult();
    }
    ...
    public Users findByName(@PathParam("username") String username) {
        return (Users)em.createNativeQuery("select * from Users u where u.user_name='" + username + "';",Users.class).getSingleResult();
    }
}
