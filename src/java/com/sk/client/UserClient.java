...
public class UserClient {
    ...
    public UserClient() {
        ...
        webTarget = client.target(BASE_URI).path("com.sk.entities.users");
    }
    ...
    public <T> T findByName_JSON(Class<T> responseType, String username) throws ClientErrorException {
        WebTarget resource = webTarget;
