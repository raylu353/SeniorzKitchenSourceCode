...
<div class="panel panel-success">
    ...
    <div class="panel-body"> 
        ...
        <div>
            <button id="submitQuantity" class="btn btn-theme" onclick="validateQuantity()">Submit To Calculate</button>
        </div>
...
<script>
    ...
    function submitQuantity() {
        ...
        if (quantity === "") {
            ...
            $('#selectorPanel').hide();
            $('#foodListPanel').load("calculator/selectedList.jsp", {"quantity": data});
        }
    }
    ;
